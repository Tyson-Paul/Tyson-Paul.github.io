...
function draw() {
  ...
  // Add memory bubble to trail
  trail.push(new MemoryBubble(mouseX, mouseY));

  // Update and display memory trail
  ...
  // Update and display firecracker bursts
...
// Mouse click triggers an explosion
